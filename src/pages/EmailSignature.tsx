    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-5">
          <div className="p-6 bg-[#FAFAFC] border border-[#E5E7EB] rounded-lg">
            ...
            <div className="space-y-3 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-[#E5E7EB] focus:border-[#3343FF] rounded px-3 py-2 text-[#0F172A] placeholder-[#94A3B8] focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-[#E5E7EB] focus:border-[#3343FF] rounded px-3 py-2 text-[#0F172A] placeholder-[#94A3B8] focus:outline-none uppercase"
                />
              </div>
          ...
          <div className="p-4 bg-[#FAFAFC] border border-[#E5E7EB] rounded-lg text-xs text-[#475569] space-y-1.5">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="p-6 bg-white border border-[#E5E7EB] rounded-lg shadow-sm">
            {/* Action Bar */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6 pb-4 border-b border-[#E5E7EB]">
              {/* Tabs */}
              <div className="flex items-center gap-1 bg-[#FAFAFC] p-1 rounded-md border border-[#E5E7EB]">
                <button
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded bg-[#3343FF] hover:bg-[#1A28D4] text-white text-xs font-semibold transition-colors shadow-sm"
                >
                ...
                <button
                  onClick={copyRawHtml}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded bg-white hover:bg-[#FAFAFC] border border-[#E5E7EB] text-[#0F172A] text-xs font-medium transition-colors"
                >
                  {copiedHtml ? <Check className="w-3.5 h-3.5 text-emerald-600" /> : <Code className="w-3.5 h-3.5" />}
            ...
            {activeTab === 'preview' ? (
              <div className="space-y-4">
                <div
                  ref={previewRef}
                  className="bg-white text-[#111111] p-6 sm:p-8 rounded-lg border border-[#E5E7EB] overflow-x-auto select-all"
              ...
              <div className="space-y-2">
                ...
                <pre className="p-4 bg-[#FAFAFC] border border-[#E5E7EB] rounded-lg text-xs font-mono text-[#0F172A] overflow-x-auto max-h-[420px] select-all leading-relaxed">
                  {signatureHtml}
                </pre>
              </div>
            )}
