...
export default function Overview() {
  return (
    <div className="space-y-12">
      {/* Edge-to-edge original blue cover banner */}
      <CoverBanner />
      ...
      <section className="space-y-5 pt-8 border-t border-[#E5E7EB]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-4">
          <div className="p-5 border border-[#E5E7EB] rounded-lg bg-[#FAFAFC]">
      ...
      <footer className="pt-8 border-t border-[#E5E7EB] flex justify-end">
        <Link
          to="/foundation"
          className="inline-flex flex-col items-end text-right group p-3 hover:bg-[#FAFAFC] rounded-lg border border-transparent hover:border-[#E5E7EB] transition-colors"
        >
